package com.application.base.registry;

import com.application.base.registry.model.XxlRegistryDataParamVO;
import com.application.base.registry.model.XxlRegistryParamVO;
import com.application.base.registry.util.json.BasicJson;
import com.application.base.registry.util.BasicHttpUtil;
 ...
 *
 * @author admin 2018-12-01 21:40:04
 */
    ...
    private Map<String, Object> requestAndValid(String pathUrl, String requestBody, int timeout){
        ...
        for (String adminAddressUrl: adminAddressArr) {
            ...
            if (resopnseMap==null
                    ...
                    || !"200".equalsIgnoreCase(String.valueOf(resopnseMap.get("code")))
                    ) {
