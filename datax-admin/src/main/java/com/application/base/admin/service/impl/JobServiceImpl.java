...
import com.application.base.admin.core.route.ExecutorRouteStrategyEnum;
import com.application.base.admin.core.thread.JobScheduleHelper;
...
public class JobServiceImpl implements JobService {
	...
	public ReturnT<String> add(JobInfo jobInfo) {
		...
		if (jobInfo.getGlueType().equalsIgnoreCase(GlueTypeEnum.BEAN.getDesc()) && jobInfo.getJobJson().trim().length()<=2) {
	...
	public ReturnT<String> update(JobInfo jobInfo) {
		...
		if (exists_jobInfo.getTriggerStatus() == 1 && !jobInfo.getJobCron().equalsIgnoreCase(exists_jobInfo.getJobCron()) ) {
			try {
		...
		if(GlueTypeEnum.BEAN.getDesc().equalsIgnoreCase(jobInfo.getGlueType())){
