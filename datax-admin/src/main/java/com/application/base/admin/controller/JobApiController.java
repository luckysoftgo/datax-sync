...
import com.application.base.admin.core.conf.JobAdminConfig;
...
import com.application.base.core.util.JobRemotingUtil;
...
public class JobApiController {
    ...
    public ReturnT<String> callback(HttpServletRequest request, @RequestBody(required = false) String data) {
        ...
        if (JobAdminConfig.getAdminConfig().getAccessToken()!=null
                ...
                && !JobAdminConfig.getAdminConfig().getAccessToken().equalsIgnoreCase(request.getHeader(JobRemotingUtil.XXL_RPC_ACCESS_TOKEN))) {
