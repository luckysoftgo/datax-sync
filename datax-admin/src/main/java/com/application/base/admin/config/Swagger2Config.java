...
public class Swagger2Config {
    ...
    public Docket defaultApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("默认接口")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.application.base.admin.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("admin", "http://localhost:8080/swagger-ui.html", "1058304821@qq.com"))
                .version("2.0")
                .build();
    }
