...
public class OracleDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public String getSQLQueryComment(String schemaName, String tableName, String columnName) {
        return String.format("select B.comments \n" +
                "  from user_tab_columns KylinConfig, user_col_comments B\n" +
                " where a.COLUMN_NAME = b.column_name\n" +
                "   and KylinConfig.Table_Name = B.Table_Name\n" +
                "   and KylinConfig.Table_Name = upper('%s')\n" +
                "   AND KylinConfig.column_name  = '%s'", tableName, columnName);
    }
