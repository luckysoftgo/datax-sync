...
import com.application.base.admin.platform.PlatformService;
import com.application.base.admin.service.IJobJdbcDatasourceService;
import com.application.base.admin.util.PageUtils;
...
public class JobJdbcDatasourceController extends ApiController {
    ...
    public R<IPage<JobJdbcDatasource>> selectAll() {
        ...
        if (platformConfig.isPswitch()){
            IPage<JobJdbcDatasource> datas = platformService.getRemoteDataSources();
    ...
    public R<JobJdbcDatasource> selectOne(@PathVariable Serializable id) {
        if (platformConfig.isPswitch()){
            JobJdbcDatasource data = platformService.getRemoteById(id);
            return success(data);
        }
