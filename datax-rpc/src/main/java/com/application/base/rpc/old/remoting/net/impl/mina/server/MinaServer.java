package com.application.base.rpc.old.remoting.net.impl.mina.server;//package com.xxl.rpc.remoting.net.impl.mina.server;
//
...
// * 		</dependency>
// *
// * @author admin 2015-11-14 17:22:09
// */
...
//							return Beat.BEAT_ID.equalsIgnoreCaseIgnoreCase(((XxlRpcRequest) message).getRequestId());
//						}
//						@Override
//						public boolean isResponse(IoSession ioSession, Object message) {
//							return Beat.BEAT_ID.equalsIgnoreCaseIgnoreCase(((XxlRpcResponse) message).getRequestId());
//						}
//						@Override
