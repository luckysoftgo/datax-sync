package com.application.base.rpc.remoting.invoker.route;

import com.application.base.rpc.remoting.invoker.route.impl.XxlRpcLoadBalanceConsistentHashStrategy;
import com.application.base.rpc.remoting.invoker.route.impl.XxlRpcLoadBalanceLFUStrategy;
import com.application.base.rpc.remoting.invoker.route.impl.XxlRpcLoadBalanceLRUStrategy;
import com.application.base.rpc.remoting.invoker.route.impl.XxlRpcLoadBalanceRandomStrategy;
import com.application.base.rpc.remoting.invoker.route.impl.XxlRpcLoadBalanceRoundStrategy;

/**
 * @author admin 2018-12-04
 */
