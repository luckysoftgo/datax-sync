package com.application.base.rpc.old.remoting.net.impl.mina.client;//package com.xxl.rpc.remoting.net.impl.mina.client;
//
...
//				return Beat.BEAT_ID.equalsIgnoreCaseIgnoreCase(((XxlRpcResponse) message).getRequestId());	// beat request
//			}
//			@Override
//			public boolean isResponse(IoSession ioSession, Object message) {
//				return Beat.BEAT_ID.equalsIgnoreCaseIgnoreCase(((XxlRpcRequest) message).getRequestId());		// beat response
//			}
//			@Override
