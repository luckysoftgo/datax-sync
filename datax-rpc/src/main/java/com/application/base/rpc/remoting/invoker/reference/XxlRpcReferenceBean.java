package com.application.base.rpc.remoting.invoker.reference;

import com.application.base.rpc.remoting.invoker.generic.XxlRpcGenericService;
import com.application.base.rpc.remoting.invoker.XxlRpcInvokerFactory;
import com.application.base.rpc.remoting.invoker.call.CallType;
import com.application.base.rpc.remoting.invoker.call.XxlRpcInvokeCallback;
import com.application.base.rpc.remoting.invoker.call.XxlRpcInvokeFuture;
...
import com.application.base.rpc.util.ClassUtil;
 ...
 *
 * @author admin 2015-10-29 20:18:32
 */
		...
		return Proxy.newProxyInstance(Thread.currentThread()
				...
				new InvocationHandler() {
					...
					public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
						...
						// filter for generic
						if (className.equalsIgnoreCase(XxlRpcGenericService.class.getName()) && methodName.equalsIgnoreCase("invoke")) {
						...
						if (className.equalsIgnoreCase(Object.class.getName())) {
