package com.application.base.rpc.remoting.provider;

import com.application.base.rpc.registry.ServiceRegistry;
import com.application.base.rpc.remoting.net.Server;
import com.application.base.rpc.remoting.net.impl.netty.server.NettyServer;
...
import com.application.base.rpc.util.ThrowableUtil;
 ...
 * provider
 *
 * @author admin 2015-10-31 22:54:27
 */
public class XxlRpcProviderFactory {
	...
	public XxlRpcResponse invokeService(XxlRpcRequest xxlRpcRequest) {
		...
		if (accessToken!=null && accessToken.trim().length()>0 && !accessToken.trim().equalsIgnoreCase(xxlRpcRequest.getAccessToken())) {
